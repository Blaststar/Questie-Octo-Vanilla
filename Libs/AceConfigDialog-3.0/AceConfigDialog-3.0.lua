...
function AceConfigDialog:Open(appName, container, a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
	...
	-- Questie-Octo's Vanilla options shell uses a ShaguTweaks-style dark pass.
	-- AceConfigDialog recreates child widgets on tab/options refresh, so reapply
	-- the theme after each Questie Options feed without affecting other apps.
	if appName == "Questie Options" and QuestieOcto and QuestieOcto.Options and QuestieOcto.Options.ApplyDarkTheme then
		QuestieOcto.Options:ApplyDarkTheme()
	end
